...
execute as @s[scores={npc_proxi=060}] run function npm:npc/npcs/funkyfox/states/state14/action2
execute as @s[scores={npc_proxi=100}] run function npm:npc/npcs/funkyfox/states/state14/action3
