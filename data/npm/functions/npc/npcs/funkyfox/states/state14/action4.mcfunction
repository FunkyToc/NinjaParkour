...
tellraw @s[tag=!lang_fr] ["",{"text":"[Easy, \"right click\"!]","bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/trigger npc_choice set 1"}}]
...
tellraw @s[tag=!lang_fr] ["",{"text":"[What objects?]","bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/trigger npc_choice set 3"}}]