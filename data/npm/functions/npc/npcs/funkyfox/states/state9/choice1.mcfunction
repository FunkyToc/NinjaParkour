...
execute as @s[tag=lang_fr] run tellraw @a ["",{"text":"<FunkyFox>","color":"#be9dff"},{"text":" LEZ'GOOOO !"}]
execute as @s[tag=!lang_fr] run tellraw @a ["",{"text":"<"},{"selector":"@s"},{"text":">"},{"text":" BRUUUUUUUUUUH!"}]
execute as @s[tag=!lang_fr] run tellraw @a ["",{"text":"<FunkyFox>","color":"#be9dff"},{"text":" BRUUUUUUUUUUH!"}]
