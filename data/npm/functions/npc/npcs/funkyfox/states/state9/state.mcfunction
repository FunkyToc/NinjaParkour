...
execute as @s[scores={npc_proxi=140}] run function npm:npc/npcs/funkyfox/states/state9/action3
execute as @s[scores={npc_proxi=200}] run function npm:npc/npcs/funkyfox/states/state9/action4
execute as @s[scores={npc_proxi=240}] run function npm:npc/npcs/funkyfox/states/state9/action5
