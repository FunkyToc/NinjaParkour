...
#Non. La réponse est à l'entrée des tutoriels. Toujours.

tellraw @s ["",{"text":"<","color":"#be9dff"},{"translate":"funkyfox.name","color":"#be9dff"},{"text":"> ","color":"#be9dff"},{"translate":"funkyfox.state17.answer1"}]
