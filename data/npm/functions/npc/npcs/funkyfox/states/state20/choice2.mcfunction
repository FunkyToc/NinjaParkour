...
# do
tellraw @s[tag=lang_fr] ["",{"text":"<FunkyFox>","color":"#be9dff"},{"text":" Je n'ai pas de poche, je suis a poil... Essais autre chose."}]
tellraw @s[tag=!lang_fr] ["",{"text":"<FunkyFox>","color":"#be9dff"},{"text":" I don't have pockets, I'm naked... Try something else."}]
