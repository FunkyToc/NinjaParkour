...
execute as @e[type=minecraft:armor_stand,tag=hud_mybest,limit=1,sort=nearest,distance=..8] at @s run setblock ~ 1 ~ minecraft:oak_sign{Text1:'[{"translate":"score.top3.mybest","bold":true},{"text":" : "},{"score":{"name":"Tmin","objective":"NPM_Score"},"bold":true},{"text":":","color":"gray"},{"score":{"name":"Tsec","objective":"NPM_Score"},"bold":true},{"text":",","color":"gray"},{"score":{"name":"Tmsec","objective":"NPM_Score"},"bold":true}]'} replace
