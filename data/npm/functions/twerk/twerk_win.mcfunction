...
tellraw @s[tag=lang_ru] ["",{"text":"COMBO !","bold":true,"color":"gold","hoverEvent":{"action":"show_text","value":"Вы чувствуете силу в вашем теле !"}},{"text":" (вы получаете эффект Насыщения)"}]
