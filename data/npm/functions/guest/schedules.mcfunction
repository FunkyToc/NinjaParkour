...
execute positioned 346.99 55.8 58 unless entity @e[type=minecraft:item,nbt={"Item":{"id":"minecraft:lapis_block"}},distance=...1] run summon item ~ ~ ~ {CustomName:'[{"text":"Lapis Key","bold":false,"color":"white"}]',Tags:["hud","hud_en","hud_fr","hud_es","hud_ge","hud_ru","hud_ko","hud_jp","hud_ch"],CustomNameVisible:0b,Item:{id:"minecraft:lapis_block",Count:1b},Age:-32768,PickupDelay:20,NoGravity:1b}
